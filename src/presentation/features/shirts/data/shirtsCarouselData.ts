...
export const shirtsCarouselData: ShirtsCaroucel[] = [
  ...
  },
  {
    ...
    price: "$36.000",
    description: "Camiseta algodón peinado manga larga - tallas menores",
  },
  {
    id: 10,
    image: algodonPeinadoTallaMayoresMangaLarga,
    price: "$39.000",
    description: "Camiseta algodón peinado manga larga - tallas mayores",
  },
  {
    id: 11,
    image: algodonNino,
  ...
  {
    id: 12,
    image: algodonPeinadoMujer,
    price: "$30.000",
    description: "Camiseta algodón peinado mujer",
  },
  {
    id: 13,
    image: pielDuraznoPresentacion,
    price: "$50.000",
  ...
  {
    id: 15,
    image: perchadoGabriela,
    price: "$50.000",
    description: "Saco perchada Gabriela",
  },
  {
    id: 16,
    image: gabrielaCuelloRedondo,
    price: "$50.000",
    description: "Saco Gabriela cuello redondo",
  },
  {
    id: 17,
    image: gabrielaCapucha,
    price: "$50.000",
    description: "Saco Gabriela con capucha",
  },
  {
    id: 18,
    image: perchadoParis,
    price: "$00.000",
    description: "Saco perchada París",
  },
];